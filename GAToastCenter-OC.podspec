#
#  Be sure to run `pod spec lint GAToastCenter-OC.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "Test how to build this"

  s.homepage     = "https://github.com/GikkiAres/GAToastCenterMaster-OC"
  ...
  s.author             = { "GikkiAres" => "GikkiAres@icloud.com" }
  # Or just: s.author    = "GikkiAres"
  # s.authors            = { "GikkiAres" => "GikkiAres@icloud.com" }
  # s.social_media_url   = "http://twitter.com/GikkiAres"
